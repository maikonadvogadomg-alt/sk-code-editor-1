    ...
    <div className="fixed inset-0 z-[9990] flex flex-col bg-[#0d1117]">
      ...
      <div className="px-4 py-3 border-b border-gray-700/30 shrink-0 bg-gradient-to-r from-purple-950/40 to-blue-950/20">
        <div className="flex items-center gap-2 mb-1.5">
          ...
          <div>
            ...
            <span className="ml-2 text-[10px] px-2 py-0.5 rounded-full bg-green-700/40 border border-green-600/30 text-green-300 font-bold">v1.1.0</span>
          </div>
          <span className="ml-auto text-[10px] text-gray-500">Build: 15/06/2026</span>
        </div>
        <div className="bg-black/20 border border-gray-700/30 rounded-xl px-3 py-2 space-y-1">
          ...
          {[
            "🚀 Painel Deploy — gera ZIP pronto para GitHub Pages, Vercel, Netlify",
            "👁 Botão Visualizar na barra — abre preview em tela cheia",
            "📖 Guia Completo — preview, servidor, URL própria, SaaS",
            "💾 Salva projetos no disco do PC a cada 15s (app desktop)",
            "🖥 Terminal sem timeout — roda npm, git, python sem travar",
            "🗄 Integração banco de dados Neon direto no app",
          ].map((item, i) => (
      ...
      <div className="px-4 py-3 border-b border-gray-700/30 shrink-0 bg-[#0d1117]">
        ...
        <div className="grid grid-cols-1 gap-1.5">
          <a
            ...
            download="MaikonJuridicoPro-v1.1.0-linux.AppImage"
          ...
          >
            ...
            <div className="flex-1">
              <div className="text-[12px] font-bold">Linux — AppImage <span className="text-[10px] font-normal text-green-400 ml-1">v1.1.0</span></div>
              <div className="text-[10px] text-purple-400/70">Build 15/06/2026 · 64-bit · Baixe, dê permissão e execute</div>
            </div>
          ...
          <a
            ...
            download="MaikonJuridicoPro-v1.1.0-windows.zip"
          ...
          >
            <span className="text-[16px]">🪟</span>
            <div className="flex-1">
              <div className="text-[12px] font-bold">Windows — Portátil <span className="text-[10px] font-normal text-green-400 ml-1">v1.1.0</span></div>
              <div className="text-[10px] text-blue-400/70">Build 15/06/2026 · 64-bit · Extraia e execute o .exe</div>
            </div>
            <div className="text-right shrink-0">
      ...
      <div className="px-4 py-3 border-b border-gray-700/30 shrink-0 bg-[#0d1117]">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-[12px] font-bold text-yellow-300">Backup do SK Editor — código-fonte completo</span>
