...
export default function SiteExtractor({ onSaveToVFS, onAnalyzeWithAI, onClose }: SiteExtractorProps) {
  ...
  return (
    <div className="h-full flex flex-col bg-[#141c0d] text-gray-200">
      {/* Header */}
      <div className="flex items-center gap-2 px-4 py-3 bg-[#1c2714] border-b border-gray-700/40 shrink-0">
