  ...
  return (
    <>
      ...
      <div className="fixed inset-x-0 bottom-0 z-[9999] pb-safe flex flex-col max-h-[92vh]" onClick={e => e.stopPropagation()}>
        <div className="bg-[#141c0d] border-t-2 border-green-700/40 rounded-t-3xl shadow-2xl flex flex-col overflow-hidden max-h-[92vh]">
            ...
            {tab === "guia" && (() => {
              ...
              return (
                <div className="p-4 space-y-3">
                  {/* Cabeçalho */}
                  <div className="bg-gradient-to-r from-green-900/30 to-blue-900/20 border border-green-700/30 rounded-xl p-4">
            ...
            {tab === "disk" && isElectron && (
              <div className="p-4 space-y-4">
                <div className="bg-[#0d1309] border border-[#2d4a1e] rounded-xl p-4">
                  ...
                  <div className="flex items-center gap-2 p-2 bg-[#141c0d] border border-gray-700/30 rounded-xl">
